...
public class DateUtils {
    ...
    public static void main(String[] args) {
        try {
            System.out.println(DateUtils.parseDate2String(DateUtils.getToday()));
            System.out.println(DateUtils.parseDate2String(DateUtils.getThisWeekMonday()));
            System.out.println(DateUtils.parseDate2String(DateUtils.getSundayOfThisWeek()));
            System.out.println(DateUtils.parseDate2String(DateUtils.getFirstDay4ThisMonth()));
            System.out.println(DateUtils.parseDate2String(DateUtils.getMonthLastDay()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
